...
<head>
    ...
    <title>ZERO zlib64 Decoder</title>
    ...
    <style>
        ...
        * {
        ...
        button {
            background: linear-gradient(45deg, #00ffcc, #009999);
            color: #121212;
            padding: 12px 20px;
            font-size: 18px;
            font-weight: bold;
        ...
        button:hover {
            background: linear-gradient(45deg, #009999, #00ffcc);
